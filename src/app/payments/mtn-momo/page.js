...
export default function MTNMomoPaymentPage() {
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Secure fee payment via MTN MoMo</p>
          </div>
        </div>
      </div>
                ...
                {idx < 2 && (
                  <div
                    className={`h-1 flex-1 mx-2 rounded transition-all ${
                      step > s.num ? "bg-yellow-500" : "bg-gray-200 dark:bg-gray-700"
                    }`}
                  />
                )}
              </div>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Enter the MTN number registered for MoMo</p>
                  </div>
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-950/30 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-yellow-900 dark:text-yellow-100">Important Information</p>
                        <ul className="text-sm text-yellow-700 dark:text-yellow-300 mt-2 space-y-1">
                          ...
                          <li>• Ensure you have sufficient balance in your MTN MoMo account</li>
                  ...
                  <Button type="submit" className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                    <span className="text-gray-600 dark:text-gray-400">MTN Number:</span>
                    <span className="font-bold">{formData.phoneNumber}</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-yellow-50 dark:bg-yellow-950/30 rounded-lg border-2 border-yellow-500">
            ...
            <Card className="border-2 border-green-500">
              <CardContent className="p-12 text-center">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="text-left">
                      ...
                      <p className="font-bold">MTN{Math.floor(Math.random() * 1000000000)}</p>
                    </div>
                ...
                <div className="flex gap-3">
                  ...
                  <Button onClick={resetForm} className="flex-1 bg-gradient-to-r from-yellow-500 to-yellow-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-950/30 dark:to-orange-950/30">
          <CardContent className="p-6">
            <Smartphone className="w-8 h-8 text-yellow-600 mb-3" />
        ...
        <Card className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              All transactions are encrypted and comply with MTN MoMo security standards
            </p>
          </CardContent>
        </Card>
        <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Zero transaction fees for education-related payments on MTN MoMo
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="text-center text-sm text-gray-500 dark:text-gray-400">
        DRAIS {DRAIS_VERSION} • Secure Payment Processing powered by MTN Mobile Money
      </div>
    </div>
  );
}
